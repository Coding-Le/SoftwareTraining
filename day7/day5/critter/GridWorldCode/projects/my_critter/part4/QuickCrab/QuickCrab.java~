...
public class QuickCrab extends CrabCritter
{
    ...
    public ArrayList<Location> getMoveLocations()
    {
        ...
        for (Location loc : myLocationsInDirections(dirs)) {
     ...
     */
    public ArrayList<Location> myLocationsInDirections(int[] directions)
    {
        ArrayList<Location> locs = new ArrayList<Location>();
        Grid gr = getGrid();
        ...
        for (int d : directions)
        {
            ...
            Location neigh = neighborLoc.getAdjacentLocation(getDirection() + d);
